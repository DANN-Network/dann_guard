                    ...
                    <tbody>
                        ...
                        @foreach ($servers as $server)
                            <tr data-server="{{ $server->uuidShort }}">
                                <td>
                                    @if($_isRestricted)
                                        <span style="cursor:not-allowed" title="BLOCKED PROTECTION DANN-GUARD">{{ $server->name }}</span>
                                    @else
                                ...
                                <td class="text-center">
                                    @if($_isRestricted)
                                        <button class="btn btn-xs btn-default" disabled title="BLOCKED PROTECTION DANN-GUARD"><i class="fa fa-wrench"></i></button>
                                    @else
